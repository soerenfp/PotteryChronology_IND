...
-------------------------------------------------------------
# The following cluster analysis is based on method 1.1 above
-------------------------------------------------------------
...
-------------------------------------------------------------
# The following cluster analysis is based on method 1.2 above
-------------------------------------------------------------
...
# --- Step 2: Compute Gower distance for mixed data ---
gower_dist <- daisy(
  ceramics_subset[, c("actual_width", "actual_diameter", "actual_height", "rim_collapsed", "att_category", "base_category")],
  metric = "gower"
)
...
# --- Step 5: Print detailed cluster summary table ---
cluster_summary <- ceramics_subset %>%
  select(vessel_number, site_name, rim_collapsed, att_category, base_category, cluster) %>%
  arrange(cluster, site_name)
...
Type 11 cannot be analysed with the cluster analysis because the data set is too small

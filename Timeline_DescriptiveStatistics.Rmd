...
# --- Step 5: List vessel numbers per cluster ---
vessel_list_by_cluster3 <- ceramics_subset3 %>%
  group_by(cluster) %>%
  summarise(vessel_numbers = paste(vessel_number, collapse = ", ")) %>%
  arrange(cluster)

# View the result in R console
print(vessel_list_by_cluster3)
...
# --- Step 5: List vessel numbers per cluster ---
vessel_list_by_cluster <- ceramics_subset6 %>%
  group_by(cluster) %>%
  summarise(vessel_numbers = paste(vessel_number, collapse = ", ")) %>%
  arrange(cluster)

# View the result in R console
print(vessel_list_by_cluster)
...
# --- Step 5: List vessel numbers per cluster ---
vessel_list_by_cluster7 <- ceramics_subset7 %>%
  group_by(cluster) %>%
  summarise(vessel_numbers = paste(vessel_number, collapse = ", ")) %>%
  arrange(cluster)

# View the result in R console
print(vessel_list_by_cluster7)
...
# --- Step 5: List vessel numbers per cluster ---
vessel_list_by_cluster9 <- ceramics_subset9 %>%
  group_by(cluster) %>%
  summarise(vessel_numbers = paste(vessel_number, collapse = ", ")) %>%
  arrange(cluster)

# View the result in R console
print(vessel_list_by_cluster9)
...
# --- Step 5: List vessel numbers per cluster ---
vessel_list_by_cluster10 <- ceramics_subset10 %>%
  group_by(cluster) %>%
  summarise(vessel_numbers = paste(vessel_number, collapse = ", ")) %>%
  arrange(cluster)

# View the result in R console
print(vessel_list_by_cluster10)

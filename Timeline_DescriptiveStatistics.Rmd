...
# 1.1 Cluster analysis per vessel type including 'width, height, orifice, rim, base' -> actual!
...
# (BAD) Cluster analysis per vessel type including size group, rim, base
...
# Type 11 (BAD, too few datapoints!)
...
# --- Step 1: Filter for one vessel type ---
vessel_type_selected <- 11  # change this to analyze another vessel type
...
Type 11 cannot be analysed with the cluster analysis because the dataset is too small

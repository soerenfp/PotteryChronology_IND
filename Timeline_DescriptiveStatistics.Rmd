...
ggplot(
  ...
  labs(
    title = "Distribution and Density of Actual Width",
    x = "Actual Width (cm)",
    y = "Density"
  ) +
  theme_minimal(base_size = 13)
...
# Cluster analysis per vessel type
...
find_optimal_clusters <- function(df) {
  numeric_data <- df %>% select(actual_width, actual_diameter, actual_height)
  max_k <- min(10, nrow(numeric_data) - 1)
  if (nrow(numeric_data) < 3) return(NA)
...
# Calculate optimal clusters per vessel type + count datapoints
...
# Plot results with datapoint count
...
Hmm, very interesting that number 6 (tightly-closed) has so many clusters!
...
# Change "1" to any other type number you want to analyze
vessel_type_selected1 <- 1

ceramics_subset1 <- ceramics_data %>%
  filter(type_category == vessel_type_selected1) %>%
  mutate(
    actual_width = na_if(actual_width, 0),
    actual_diameter = na_if(actual_diameter, 0),
    actual_height = na_if(actual_height, 0)
...
scaled_data1 <- scale(ceramics_subset1[, c("actual_width", "actual_diameter", "actual_height")])

# --- Step 3: Perform clustering (k = 2, since that was optimal before) ---
set.seed(123)
kmeans_result1 <- kmeans(scaled_data1, centers = 2, nstart = 25)

ceramics_subset1$cluster <- as.factor(kmeans_result1$cluster)

# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset1, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
    title = paste("Cluster Analysis for Vessel Type", vessel_type_selected1),
    x = "Actual Width (cm)",
    y = "Actual Height (cm)",
    color = "Cluster"
  ) +
...
# --- Step 3: Perform clustering (k = 4, since that was optimal before) ---
set.seed(123)
...
# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset2, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
...
# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset3, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
...
# --- Step 1: Filter for one vessel type ---
# Change "1" to any other type number you want to analyze
vessel_type_selected4 <- 4

ceramics_subset4 <- ceramics_data %>%
  filter(type_category == vessel_type_selected4) %>%
  mutate(
    actual_width = na_if(actual_width, 0),
    actual_diameter = na_if(actual_diameter, 0),
    actual_height = na_if(actual_height, 0)
...
# --- Step 2: Scale numeric data for fair comparison ---
scaled_data4 <- scale(ceramics_subset4[, c("actual_width", "actual_diameter", "actual_height")])

# --- Step 3: Perform clustering (k = 4, since that was optimal before) ---
set.seed(123)
kmeans_result4 <- kmeans(scaled_data4, centers = 2, nstart = 25)

ceramics_subset4$cluster <- as.factor(kmeans_result4$cluster)

# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset4, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
    title = paste("Cluster Analysis for Vessel Type", vessel_type_selected4),
    x = "Actual Width (cm)",
    y = "Actual Height (cm)",
    color = "Cluster"
  ) +
...
# --- Step 1: Filter for one vessel type ---
# Change "1" to any other type number you want to analyze
vessel_type_selected5 <- 5

ceramics_subset5 <- ceramics_data %>%
  filter(type_category == vessel_type_selected5) %>%
  mutate(
    actual_width = na_if(actual_width, 0),
    actual_diameter = na_if(actual_diameter, 0),
    actual_height = na_if(actual_height, 0)
...
# --- Step 2: Scale numeric data for fair comparison ---
scaled_data5 <- scale(ceramics_subset5[, c("actual_width", "actual_diameter", "actual_height")])

# --- Step 3: Perform clustering (k = 4, since that was optimal before) ---
set.seed(123)
kmeans_result5 <- kmeans(scaled_data5, centers = 2, nstart = 25)

ceramics_subset5$cluster <- as.factor(kmeans_result5$cluster)

# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset5, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
    title = paste("Cluster Analysis for Vessel Type", vessel_type_selected5),
    x = "Actual Width (cm)",
    y = "Actual Height (cm)",
    color = "Cluster"
  ) +
...
# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset6, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
...
# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset7, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
...
# --- Step 1: Filter for one vessel type ---
# Change "1" to any other type number you want to analyze
vessel_type_selected8 <- 8

ceramics_subset8 <- ceramics_data %>%
  filter(type_category == vessel_type_selected8) %>%
  mutate(
    actual_width = na_if(actual_width, 0),
    actual_diameter = na_if(actual_diameter, 0),
    actual_height = na_if(actual_height, 0)
...
# --- Step 2: Scale numeric data for fair comparison ---
scaled_data8 <- scale(ceramics_subset8[, c("actual_width", "actual_diameter", "actual_height")])

# --- Step 3: Perform clustering (k = 4, since that was optimal before) ---
set.seed(123)
kmeans_result8 <- kmeans(scaled_data8, centers = 2, nstart = 25)

ceramics_subset8$cluster <- as.factor(kmeans_result8$cluster)

# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset8, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
    title = paste("Cluster Analysis for Vessel Type", vessel_type_selected8),
    x = "Actual Width (cm)",
    y = "Actual Height (cm)",
    color = "Cluster"
  ) +
...
# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset9, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(
...
# --- Step 4: Visualize the clusters ---
ggplot(ceramics_subset10, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  labs(

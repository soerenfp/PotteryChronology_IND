...
- OBS: I noticed I misspelled the "rim_category" in the excel sheet -> correct this!
...
ceramics_subset <- ceramics_data %>%
  ...
  select(site_name, type_category, size_category, rim_categroy, base_category, 
...
```
OBS: I think I need to include the vessels with 0.0 values in actual_diameter. But otherwise the plot looks nice!

...
ggplot(ceramics_long, aes(x = Value, fill = Measurement)) +
  ...
  facet_wrap(~ type_category, scales = "free_y") +
  scale_fill_manual(values = c("Width" = "#1f77b4", "Height" = "#2ca02c", "Orifice" = "#ff7f0e")) +
  labs(
    title = "Density Plot of Width, Height, and Orifice Diameter by Vessel Type",
...
# Add vessel numbers (If I need it)
...
# --- Step 4: Plot with smart vessel labels ---
ggplot(ceramics_subset1, aes(x = actual_width, y = actual_height, color = cluster)) +
  geom_point(size = 3, alpha = 0.8) +
  geom_text_repel(
...
Hmm, I need to decide if I need the vessel numbers..

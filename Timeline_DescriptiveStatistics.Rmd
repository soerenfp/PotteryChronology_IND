...
legend_table_vessel <- data.frame(
  ...
  Description = c("Wide-open sphere", "Open sphere", "Closed hor. ellipsoid", 
                  ...
                  "Tightly-closed ver. ellipsoid", 
                  "Flasks", "Tripods", "Tripods (top)")
)
...
legend_table_attribute <- data.frame(
  Attribute_Type = 1:4,
  Abbreviation = c("H", "Sp", "K", "Pl"),
  Description = c("Handles", "Spouts", "Knobs", "Plastic Band")
)
...
#descriptive_stats_type12 <- ceramics_data %>%
#  filter(type_category == "12") %>%
#  summarise(
#    across(all_of(numeric_vars),
#           list(
#             mean = ~mean(.x, na.rm = TRUE),
...
#  descriptive_stats_type12 %>% mutate(vessel_type = 12),
...
# =========================================================
# STEP 4: PLOT FUNCTION (UNCHANGED)
# =========================================================
...
# =========================================================
# STEP 6: OPTIONAL — EXPORT TO EXCEL
# =========================================================
